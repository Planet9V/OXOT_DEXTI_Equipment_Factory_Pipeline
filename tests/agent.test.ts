...
describe('DexpiAgent', () => {
    ...
    test('findVendorVariations returns parsed array', async () => {
        ...
        // Verify correct persona was used and system prompt context replaced
        ...
        expect(fetchBody.messages[1].content).not.toContain('P-101'); // user message shouldn't have it anymore
    });
