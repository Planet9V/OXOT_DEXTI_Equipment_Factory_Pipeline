...
describe('DexpiAgent', () => {
    ...
    test('generateEquipmentCards uses theEngineer persona and returns parsed array', async () => {
        const fakeCards = [
            {
        ...
        expect(systemMsg).toContain('Centrifugal Pump'); // Substituted list
    });
});
