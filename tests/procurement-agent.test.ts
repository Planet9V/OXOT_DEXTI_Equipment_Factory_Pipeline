...
describe('ProcurementAgent', () => {
    ...
    it('should handle wrapped JSON responses (object with variations key) by throwing an error', async () => {
    ...
    it('should handle wrapped JSON responses (object with models key) by throwing an error', async () => {
        const mockEquipment = { tag: 'TAG-001' } as unknown as EquipmentCard;
