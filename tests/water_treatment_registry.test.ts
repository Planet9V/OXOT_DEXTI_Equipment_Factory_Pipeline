...
describe('Water Treatment Equipment Registry', () => {
    const registryPath = path.join(__dirname, '../src/lib/resources/water_treatment_registry.json');
    ...
    it('should contain valid JSON with required fields', () => {
        ...
        expect(registry).toHaveProperty('sector', 'WATER_TREATMENT');
        expect(registry).toHaveProperty('subSector', 'WT-ALL');
