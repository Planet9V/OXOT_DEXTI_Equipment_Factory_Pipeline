...
describe('Procurement Officer Persona', () => {
    ...
    test('should return vendor variations when a valid JSON response is received', async () => {
        ...
        // Verify the system prompt contained the reference equipment correctly injected
        ...
        // Verify the user message is the concise variant
        const userMessage = messages.find((m: any) => m.role === 'user');
        expect(userMessage.content).toContain('Find 3 distinct real-world vendor models for the provided Reference Equipment.');
    });
