...
describe('Procurement Officer Persona', () => {
    ...
    test('should return vendor variations when a valid JSON response is received', async () => {
        ...
        // Verify system prompt is for procurement officer and contains the injected context
        ...
        expect(userMessage.content).toContain('Find 3 distinct real-world vendor models');
    });
