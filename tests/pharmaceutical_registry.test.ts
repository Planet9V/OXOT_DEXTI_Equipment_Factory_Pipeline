...
describe('Pharmaceutical Equipment Registry', () => {
    const registryPath = path.join(__dirname, '../src/lib/resources/pharmaceutical_registry.json');
    ...
    it('should contain valid JSON with required fields', () => {
        ...
        expect(registry).toHaveProperty('sector', 'PHAR');
        expect(registry).toHaveProperty('subSector', 'PHAR-ALL');
