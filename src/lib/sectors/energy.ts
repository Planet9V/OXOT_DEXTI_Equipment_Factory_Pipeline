            ...
            facilities: [
                {
                    ...
                    equipment: [
                        ...
                        { componentClass: 'ProcessColumn', componentClassURI: URI.PROCESS_COLUMN_URI, displayName: 'Stripper Column', category: 'static', typicalQuantity: { min: 1, max: 4 } },
                        { componentClass: 'ProcessColumn', componentClassURI: URI.PROCESS_COLUMN_URI, displayName: 'Splitter Column', category: 'static', typicalQuantity: { min: 1, max: 3 } },
                        { componentClass: 'Reactor', componentClassURI: URI.REACTOR_URI, displayName: 'Reformer Reactor', category: 'static', typicalQuantity: { min: 1, max: 3 } },
                        { componentClass: 'Reactor', componentClassURI: URI.REACTOR_URI, displayName: 'Alkylation Reactor', category: 'static', typicalQuantity: { min: 1, max: 2 } },
                        { componentClass: 'Drum', componentClassURI: URI.DRUM_URI, displayName: 'Coker Drum', category: 'static', typicalQuantity: { min: 2, max: 6 } },
                        { componentClass: 'Vessel', componentClassURI: URI.VESSEL_URI, displayName: 'Desalter Vessel', category: 'static', typicalQuantity: { min: 1, max: 2 } },
                        { componentClass: 'Boiler', componentClassURI: URI.BOILER_URI, displayName: 'Waste Heat Boiler', category: 'heat-transfer', typicalQuantity: { min: 2, max: 6 } },
                        { componentClass: 'PlateHeatExchanger', componentClassURI: URI.PLATE_HX_URI, displayName: 'Plate Heat Exchanger', category: 'heat-transfer', typicalQuantity: { min: 5, max: 20 } },
                        { componentClass: 'ShellTubeHeatExchanger', componentClassURI: URI.SHELL_TUBE_HX_URI, displayName: 'Kettle Reboiler', category: 'heat-transfer', typicalQuantity: { min: 5, max: 15 } },
                        { componentClass: 'ReciprocatingCompressor', componentClassURI: URI.RECIPROCATING_COMPRESSOR_URI, displayName: 'Reciprocating Compressor', category: 'rotating', typicalQuantity: { min: 2, max: 8 } },
                        { componentClass: 'SteamTurbine', componentClassURI: URI.STEAM_TURBINE_URI, displayName: 'Steam Turbine Driver', category: 'rotating', typicalQuantity: { min: 4, max: 12 } },
                        { componentClass: 'Motor', componentClassURI: URI.MOTOR_URI, displayName: 'HV Electric Motor', category: 'electrical', typicalQuantity: { min: 10, max: 50 } },
                        { componentClass: 'ElectricGenerator', componentClassURI: URI.GENERATOR_URI, displayName: 'Backup Diesel Generator', category: 'electrical', typicalQuantity: { min: 1, max: 4 } },
                        { componentClass: 'Switchgear', componentClassURI: URI.SWITCHGEAR_URI, displayName: 'MV Switchgear', category: 'electrical', typicalQuantity: { min: 4, max: 12 } },
                        { componentClass: 'UPS', componentClassURI: URI.UPS_URI, displayName: 'UPS System', category: 'electrical', typicalQuantity: { min: 2, max: 6 } },
                        // Valves
                        { componentClass: 'ControlValve', componentClassURI: URI.CONTROL_VALVE_URI, displayName: 'Globe Control Valve', category: 'piping', typicalQuantity: { min: 50, max: 200 } },
                        { componentClass: 'ControlValve', componentClassURI: URI.CONTROL_VALVE_URI, displayName: 'Butterfly Control Valve', category: 'piping', typicalQuantity: { min: 20, max: 80 } },
                        { componentClass: 'CheckValve', componentClassURI: URI.CHECK_VALVE_URI, displayName: 'Swing Check Valve', category: 'piping', typicalQuantity: { min: 50, max: 150 } },
                        { componentClass: 'GateValve', componentClassURI: URI.GATE_VALVE_URI, displayName: 'Gate Valve', category: 'piping', typicalQuantity: { min: 200, max: 800 } },
                        { componentClass: 'BallValve', componentClassURI: URI.BALL_VALVE_URI, displayName: 'Ball Valve', category: 'piping', typicalQuantity: { min: 100, max: 400 } },
                        { componentClass: 'SafetyValve', componentClassURI: URI.SAFETY_VALVE_URI, displayName: 'Rupture Disc', category: 'piping', typicalQuantity: { min: 10, max: 40 } },
                        // Instrumentation
                        { componentClass: 'FlowMeter', componentClassURI: URI.FLOW_METER_URI, displayName: 'Coriolis Flow Meter', category: 'instrumentation', typicalQuantity: { min: 10, max: 50 } },
                        { componentClass: 'FlowMeter', componentClassURI: URI.FLOW_METER_URI, displayName: 'Vortex Flow Meter', category: 'instrumentation', typicalQuantity: { min: 20, max: 80 } },
                        { componentClass: 'FlowMeter', componentClassURI: URI.FLOW_METER_URI, displayName: 'Ultrasonic Flow Meter', category: 'instrumentation', typicalQuantity: { min: 5, max: 20 } },
                        { componentClass: 'LevelIndicator', componentClassURI: URI.LEVEL_INDICATOR_URI, displayName: 'Radar Level Transmitter', category: 'instrumentation', typicalQuantity: { min: 20, max: 60 } },
                        { componentClass: 'LevelIndicator', componentClassURI: URI.LEVEL_INDICATOR_URI, displayName: 'Displacer Level Transmitter', category: 'instrumentation', typicalQuantity: { min: 10, max: 40 } },
                        { componentClass: 'Transmitter', componentClassURI: URI.TRANSMITTER_URI, displayName: 'Pressure Transmitter', category: 'instrumentation', typicalQuantity: { min: 100, max: 300 } },
                        { componentClass: 'TemperatureSensor', componentClassURI: URI.TEMPERATURE_SENSOR_URI, displayName: 'Temperature Transmitter', category: 'instrumentation', typicalQuantity: { min: 100, max: 300 } },
                        { componentClass: 'Analyzer', componentClassURI: URI.ANALYZER_URI, displayName: 'Gas Chromatograph', category: 'instrumentation', typicalQuantity: { min: 5, max: 20 } },
                        { componentClass: 'Analyzer', componentClassURI: URI.ANALYZER_URI, displayName: 'pH Analyzer', category: 'instrumentation', typicalQuantity: { min: 2, max: 8 } },
                        { componentClass: 'CentrifugalPump', componentClassURI: URI.CENTRIFUGAL_PUMP_URI, displayName: 'Fire Water Pump', category: 'rotating', typicalQuantity: { min: 2, max: 4 } },
                        { componentClass: 'Compressor', componentClassURI: URI.COMPRESSOR_URI, displayName: 'Instrument Air Compressor', category: 'rotating', typicalQuantity: { min: 2, max: 4 } },
                    ],
                },
                {
                    code: 'ENER-OG-PIPE',
