...
export class DexpiAgent {
    ...
    /**
     * Generate DEXPI 2.0 equipment cards for a list of equipment types.
     *
    ...
    async generateEquipmentCards(equipmentTypes: string[]): Promise<any[]> {
        const context: AgentContext = {
            additionalInstructions: `Task: Generate **Full-Fidelity** DEXPI 2.0 equipment cards for the following list of equipment types:\n- ${equipmentTypes.join('\n- ')}`
        };
