...
- Return ONLY valid JSON array, no markdown.`;
     ...
     * @returns Array of generated DEXPI 2.0 equipment cards.
     */
    async generateFullFidelityCards(equipmentTypes: Record<string, unknown>[]): Promise<Record<string, unknown>[]> {
