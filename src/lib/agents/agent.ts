...
const PERSONAS = {
    ...
    theEngineer: `You are "The Engineer," a detailed mechanical specification expert. Your task is to generate **Full-Fidelity** DEXPI 2.0 equipment cards for lists of equipment types.
