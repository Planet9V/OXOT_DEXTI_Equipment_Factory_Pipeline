...
Task: Generate **Full-Fidelity** DEXPI 2.0 equipment cards.
For each item requested, generate a JSON object that is **100% compliant** with the DEXPI 2.0 Schema. Do NOT produce simplified or partial records.
