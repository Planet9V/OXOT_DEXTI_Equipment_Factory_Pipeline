...
Return ONLY valid JSON, no markdown.`;
    ...
    async generateReferenceCards(equipmentTypes: any[]): Promise<any[]> {
        const prompt = PERSONAS.theEngineer.replace(
            '[LIST_OF_TYPES_FROM_REGISTRY]',
        ...
        try {
            ...
            console.warn('[agent] Failed to parse full-fidelity cards JSON');
        }
