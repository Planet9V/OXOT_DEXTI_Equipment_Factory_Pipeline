...
/**
 * Returns a lightweight summary of the Government sector for the hub page.
 */
export function getGovernmentSummary(): SectorSummary {
    const data = getGovernmentStepData();
    return {
